...
static struct {
	...
	{
		CMD_LOADFILE, {
	arg_NONE}, NULL, FALSE, 0}, {
		CMD_NEWGAME, {
	arg_NONE}, NULL, FALSE, 0}, {
		CMD_BIRTH_RESET, {
	arg_NONE}, NULL, FALSE, 0}, {
		CMD_CHOOSE_SEX, {
	arg_CHOICE}, NULL, FALSE, 0}, {
		CMD_CHOOSE_RACE, {
	arg_CHOICE}, NULL, FALSE, 0}, {
		CMD_CHOOSE_CLASS, {
	arg_CHOICE}, NULL, FALSE, 0}, {
	...
	arg_NONE}, NULL, FALSE, 0}, {
		CMD_NAME_CHOICE, {
	arg_STRING}, NULL, FALSE, 0}, {
		CMD_ACCEPT_CHARACTER, {
	arg_NONE}, NULL, FALSE, 0}, {
		CMD_GO_UP, {
	arg_NONE}, do_cmd_go_up, FALSE, 0}, {
		CMD_GO_DOWN, {
	arg_NONE}, do_cmd_go_down, FALSE, 0}, {
		CMD_SEARCH, {
	arg_NONE}, do_cmd_search, TRUE, 10}, {
		CMD_TOGGLE_SEARCH, {
	arg_NONE}, do_cmd_toggle_search, FALSE, 0}, {
		CMD_WALK, {
	arg_DIRECTION}, do_cmd_walk, TRUE, 0}, {
		CMD_RUN, {
	arg_DIRECTION}, do_cmd_run, FALSE, 0}, {
		CMD_JUMP, {
	arg_DIRECTION}, do_cmd_jump, FALSE, 0}, {
		CMD_OPEN, {
	arg_DIRECTION}, do_cmd_open, TRUE, 99}, {
		CMD_CLOSE, {
	arg_DIRECTION}, do_cmd_close, TRUE, 99}, {
		CMD_TUNNEL, {
	arg_DIRECTION}, do_cmd_tunnel, TRUE, 99}, {
		CMD_HOLD, {
	arg_NONE}, do_cmd_hold, TRUE, 0}, {
		CMD_DISARM, {
	arg_DIRECTION}, do_cmd_disarm, TRUE, 99}, {
		CMD_BASH, {
	arg_DIRECTION}, do_cmd_bash, TRUE, 99}, {
		CMD_ALTER, {
	arg_DIRECTION}, do_cmd_alter, TRUE, 99}, {
		CMD_JAM, {
	arg_DIRECTION}, do_cmd_spike, FALSE, 0}, {
		CMD_REST, {
	arg_CHOICE}, do_cmd_rest, FALSE, 0}, {
		CMD_PATHFIND, {
	arg_POINT}, do_cmd_pathfind, FALSE, 0}, {
		CMD_PICKUP, {
	arg_ITEM}, do_cmd_pickup, FALSE, 0}, {
		CMD_WIELD, {
	arg_ITEM, arg_NUMBER}, do_cmd_wield, FALSE, 0}, {
		CMD_TAKEOFF, {
	arg_ITEM}, do_cmd_takeoff, FALSE, 0}, {
		CMD_DROP, {
	arg_ITEM, arg_NUMBER}, do_cmd_drop, FALSE, 0}, {
		CMD_UNINSCRIBE, {
	arg_ITEM}, do_cmd_uninscribe, FALSE, 0}, {
		CMD_EAT, {
	arg_ITEM}, do_cmd_use, FALSE, 0}, {
		CMD_QUAFF, {
	arg_ITEM, arg_TARGET}, do_cmd_use, FALSE, 0}, {
		CMD_USE_ROD, {
	arg_ITEM, arg_TARGET}, do_cmd_use, FALSE, 0}, {
		CMD_USE_STAFF, {
	arg_ITEM}, do_cmd_use, FALSE, 0}, {
	...
	arg_ITEM, arg_TARGET}, do_cmd_use, FALSE, 0}, {
		CMD_REFILL, {
	arg_ITEM}, do_cmd_refill, FALSE, 0}, {
		CMD_FIRE, {
	arg_ITEM, arg_TARGET}, do_cmd_fire, FALSE, 0}, {
		CMD_THROW, {
	arg_ITEM, arg_TARGET}, do_cmd_throw, FALSE, 0}, {
		CMD_DESTROY, {
	arg_ITEM, arg_NUMBER}, do_cmd_destroy, FALSE, 0}, {
		CMD_INSCRIBE, {
	arg_ITEM, arg_STRING}, do_cmd_inscribe, FALSE, 0}, {
		CMD_STUDY_SPELL, {
	arg_CHOICE}, do_cmd_study_spell, FALSE, 0}, {
		CMD_STUDY_BOOK, {
	arg_ITEM}, do_cmd_study_book, FALSE, 0}, {
		CMD_CAST, {
	arg_CHOICE, arg_TARGET}, do_cmd_cast, FALSE, 0}, {
		CMD_SUICIDE, {
	arg_NONE}, do_cmd_suicide, FALSE, 0}, {
		CMD_SAVE, {
	arg_NONE}, do_cmd_save_game, FALSE, 0}, {
		CMD_QUIT, {
	arg_NONE}, do_cmd_quit, FALSE, 0}, {
		CMD_HELP, {
	arg_NONE}, NULL, FALSE, 0}, {
		CMD_REPEAT, {
arg_NONE}, NULL, FALSE, 0},};
