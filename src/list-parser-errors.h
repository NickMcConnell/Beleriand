...
PARSE_ERROR(INVALID_BREATH_CODE,	"invalid code for dragon breath")
...
PARSE_ERROR(INVALID_MAP,			"invalid map")
...
PARSE_ERROR(INVALID_PLAY_RACE_NAME,	"invalid player race name")
PARSE_ERROR(INVALID_PROPERTY,		"invalid object property type")
PARSE_ERROR(INVALID_QUEST_TYPE,		"invalid quest type")
...
PARSE_ERROR(INVALID_STRING,			"invalid string")
...
PARSE_ERROR(MISSING_MAP,			"missing map")
