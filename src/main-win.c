...
static void save_prefs(void)
{
	...
	WritePrivateProfileStringA("Angband", "Graphics", buf, ini_file);
        ...
        WritePrivateProfileStringA("Angband", "TileWid", buf, ini_file);

        /* Save the tile height */
        strnfmt(buf, sizeof(buf), "%d", tile_height);
        WritePrivateProfileStringA("Angband", "TileHgt", buf, ini_file);
...
static void load_prefs(void)
{
	...
	tile_width = GetPrivateProfileIntA("Angband", "TileWid", false,
		ini_file);

	/* Extract the tile height */
	tile_height = GetPrivateProfileIntA("Angband", "TileHgt", false,
		ini_file);
