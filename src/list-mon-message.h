...
MON_MSG(NOTICE,				MSG_GENERIC,	false,	"notice[s] you.")
MON_MSG(WAKE_AND_NOTICE,	MSG_GENERIC,	false,	"wake[s] up and notice[s] you.")
MON_MSG(STIR,				MSG_GENERIC,	false,	"stir[s].")
MON_MSG(LOOK_AROUND,		MSG_GENERIC,	false,	"look[s] around.")
MON_MSG(BECOME_UNWARY,		MSG_GENERIC,	false,	"become[s] unwary.")
...
MON_MSG(LOSE_SKIN,			MSG_GENERIC,	false,	"partly shatter[s]!")
MON_MSG(DISSOLVE,			MSG_KILL,		false,	"shatter[s]!")
...
MON_MSG(TURN_TO_FIGHT,		MSG_GENERIC,	false,	"turn[s] to fight!")
MON_MSG(RECOVER_COMPOSURE,	MSG_GENERIC,	false,	"recover[s] [its|their] composure.")
MON_MSG(PANIC,				MSG_GENERIC,	false,	"panics.")
MON_MSG(STAGGER_DOOR,		MSG_GENERIC,	false,	"staggers into a door.")
MON_MSG(STAGGER_RUBBLE,		MSG_GENERIC,	false,	"staggers into some rubble.")
MON_MSG(STAGGER_WALL,		MSG_GENERIC,	false,	"bashes into a wall.")
MON_MSG(HELD,				MSG_GENERIC,    false,  "[is|are] frozen to the spot!")
MON_MSG(NOT_HELD,			MSG_GENERIC,    false,  "can move again.")
MON_MSG(PUSHED,				MSG_GENERIC,    false,  "[is|are] blown backwards by the force.")
MON_MSG(NOT_PUSHED,			MSG_GENERIC,    false,  "holds firm against the force of the blast.")
...
MON_MSG(GO_UP_STAIRS,		MSG_GENERIC,	false,	"[goes|go] up the stairs.")
MON_MSG(GO_DOWN_STAIRS,		MSG_GENERIC,	false,	"[goes|go] down the stairs.")
MON_MSG(FLEE_UP_STAIRS,		MSG_GENERIC,	false,	"flee[s] up the stairs.")
MON_MSG(FLEE_DOWN_STAIRS,	MSG_GENERIC,	false,	"flee[s] down the stairs.")
MON_MSG(EXCHANGE,			MSG_GENERIC,	false,	"exchanges places with you.")
MON_MSG(FLANK,				MSG_GENERIC,	false,	"attacks you as it moves by.")
MON_MSG(PASS_DOOR,			MSG_GENERIC,	false,	"passes under the door.")
MON_MSG(END_SONG,			MSG_GENERIC,	false,	"ends his song.")
/* Dummy messages for monster pain, pursuit, warning - use edit file info. */
MON_MSG(66,					MSG_GENERIC,	true,	"")
MON_MSG(33,					MSG_GENERIC,	true,	"")
MON_MSG(0,					MSG_GENERIC,	true,	"")
MON_MSG(PURSUE_VIS,			MSG_GENERIC,	false,	"")
MON_MSG(PURSUE_CLOSE,		MSG_GENERIC,	true,	"")
MON_MSG(PURSUE_FAR,			MSG_GENERIC,	true,	"")
MON_MSG(WARN_VIS,			MSG_GENERIC,	false,	"")
MON_MSG(WARN_INVIS,			MSG_GENERIC,	true,	"")
MON_MSG(WARN_VIS_SIL,		MSG_GENERIC,	false,	"")
MON_MSG(WARN_INVIS_SIL,		MSG_GENERIC,	true,	"")
